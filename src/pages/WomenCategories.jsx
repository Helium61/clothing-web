...
const items = [
  { id: '1', name: 'Jacket', price: '$19.99', image: Image5 },
  { id: '2', name: 'Jacket', price: '$49.99', image:Image6 },
  { id: '3', name: 'Jacket', price: '$89.99', image: Image7 },
  { id: '4', name: 'Jacket', price: '$69.99', image:Image8 }
];

const WomenCategories = () => {
  return (
    <div className="p-10">
      <h1 className="text-4xl font-serif mb-8 text-center">Womens Clothing Categories</h1>
